...
/* Command for C compiler:
   clang -c  -w  -I/Users/patiencenkurumeh/.choosenim/toolchains/nim-0.18.0/lib -o /Users/patiencenkurumeh/Other/kernel/c/nimcache/stdlib_os.o /Users/patiencenkurumeh/Other/kernel/c/nimcache/stdlib_os.c */
...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_17, ".", 1);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_18, "..", 2);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_19, "\012not (path == \"\") ", 18);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_21, "Failed to create the directory", 30);
		...
		while (1) {
			...
			LA7_: ;
			{
				...
				LA13_: ;
				{
					...
					raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T20_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_7));
				}
				LA11_: ;
			}
			LA3_: ;
...
{	result = (NimStringDesc*)0;
		...
		if (!T3_) goto LA4_;
		{
			...
			i = ((NI) 0);
			{
				...
				while (1) {
					...
					TM_yu6cxgKBBXbNsTkT9cyMd4g_8 = addInt(i, ((NI) 1));
					i = (NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_8);
				} LA8: ;
			}
		}
	}
	LA4_: ;
	nimln_(150, "os.nim");
	path = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_9), ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_7));
	{
		...
		splits = ((NI) -1);
		{
			...
			while (1) {
				...
				TM_yu6cxgKBBXbNsTkT9cyMd4g_11 = subInt(last, ((NI) 1));
				candidate = copyStrLast(path, first, (NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_11));
				nimln_(157, "os.nim");
				...
				x = slash__lXoMhn1ZYc9cAJa9bfA61msg(T25_, exe);
				{
					...
					i_2 = ((NI) 0);
					{
						...
						while (1) {
									...
									while (1) {
										...
										nimln_(163, "os.nim");
										{
											...
											nimln_(166, "os.nim");
											{
												...
												raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T45_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_7));
											}
											LA43_: ;
											nimln_(168, "os.nim");
											{
												...
												r = mnewString(((NI)chckRange((NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_12), ((NI) 0), ((NI) IL64(9223372036854775807)))));
												nimln_(170, "os.nim");
							...
							LA32_: ;
							nimln_(2188, "system.nim");
							TM_yu6cxgKBBXbNsTkT9cyMd4g_13 = addInt(i_2, ((NI) 1));
							i_2 = (NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_13);
						} LA28: ;
					}
				}
				...
				TM_yu6cxgKBBXbNsTkT9cyMd4g_14 = subInt(splits, ((NI) 1));
				splits = (NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_14);
...
{	result = (NI64)0;
	...
	nimln_(185, "os.nim");
	{
		...
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T6_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_7));
	}
	LA4_: ;
	nimln_(186, "os.nim");
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_PathComponent_9c1SIU9cO1wHcl09b703A9cDrg, getSymlinkFileKind_WoXOp8qmMec1P4MyA3LBKg)(NimStringDesc* path) {
	...
	nimln_(739, "os.nim");
	{
		...
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T10_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_7));
	}
	LA8_: ;
	nimln_(741, "os.nim");
	{
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir_P9aOuM3pg25yKqgBUm7qKng)(NimStringDesc* dir) {
	...
	nimln_(876, "os.nim");
	{
		...
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T8_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_7));
	}
	LA6_: ;
	popFrame();
}
					...
					while (1) {
						{
							...
							nimln_(808, "os.nim");
							{
								...
								nimln_(398, "system.nim");
								nimln_(808, "os.nim");
								T16_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_17)));
								if (!(T16_)) goto LA17_;
								nimln_(398, "system.nim");
								nimln_(808, "os.nim");
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, existsOrCreateDir_V86QyZrcGMPX0W9bv1Q53ww)(NimStringDesc* dir) {
	...
	nimln_(934, "os.nim");
	{
		...
		nimln_(936, "os.nim");
		{
			...
			T11_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_21));
...
static N_INLINE(NIM_CHAR, X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgsystem)(NimStringDesc* s, NI i) {
	...
	TM_yu6cxgKBBXbNsTkT9cyMd4g_24 = subInt((s ? s->Sup.len : 0), i);
	if ((NU)((NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_24)) > (NU)(s->Sup.len)) raiseIndexError();
	result = s->data[(NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_24)];
	popFrame();
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitNext = NIM_FALSE;
	{
		...
		colontmp_ = (NI)0;
		nimln_(950, "os.nim");
		TM_yu6cxgKBBXbNsTkT9cyMd4g_20 = subInt((dir ? dir->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_20);
		nimln_(2045, "system.nim");
		res = ((NI) 1);
		{
			nimln_(2046, "system.nim");
			while (1) {
				...
				nimln_(951, "os.nim");
				{
					...
					LA10_: ;
					{
						...
						NIM_BOOL T14_;
						nimln_(955, "os.nim");
						TM_yu6cxgKBBXbNsTkT9cyMd4g_22 = subInt(i, ((NI) 1));
						T13_ = (NimStringDesc*)0;
						T13_ = copyStrLast(dir, ((NI) 0), (NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_22));
						T14_ = (NIM_BOOL)0;
				...
				LA6_: ;
				nimln_(2048, "system.nim");
				TM_yu6cxgKBBXbNsTkT9cyMd4g_23 = addInt(res, ((NI) 1));
				res = (NI)(TM_yu6cxgKBBXbNsTkT9cyMd4g_23);
			} LA3: ;
		}
	}
	nimln_(958, "os.nim");
